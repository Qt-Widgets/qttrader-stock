...
#ifndef PLUGIN_MARKER_SELL_H
#define PLUGIN_MARKER_SELL_H

#include <QObject>
#include "QtTraderPlugin.h"

class MarkerSell : public QObject, public IMarkerPlugin
{
  Q_OBJECT
  ...
  public:
    QString pluginName() { return QString("Sell Marker");}
