...
autoTraderDialog::autoTraderDialog (QWidget *p) : QDialog (p)
{
  _settings = 0;
  _modified = 0;
...
void autoTraderDialog::cancel ()
{
  saveSettings();
  reject();
}

void autoTraderDialog::loadSettings ()
{
...
void autoTraderDialog::saveSettings ()
{
  QSettings settings(g_settings);
  settings.beginGroup(g_session);
...
void autoTraderDialog::setGUI (Entity *settings)
{
  _settings = settings;
...
void autoTraderDialog::modified ()
{
  _modified = 1;
}
