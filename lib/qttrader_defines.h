...
//Changes are to be made in qttrader.pro. Then re-run ./configure to generate this file
#ifndef QTTRADER_DEFINES_H
#define QTTRADER_DEFINES_H
#define INSTALL_BIN_DIR "/home/mattias/qttrader_debug"
